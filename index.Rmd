...
knitr::opts_chunk$set(
  comment = '', prompt=FALSE, out.width="60%", fig.align='center', warning=FALSE, message=FALSE
)
```
...
Wo kommt das hier her?: Dieses Buch baut technnisch auf *knitr* [@xie2015], *rmarkdown* [@R-rmarkdown], R [@R-base] und vielen weiteren Open-Source-Anwendungen. Details sind im Kapitel \@ref(hinweise) hinterlegt. Lorem Ipsum.