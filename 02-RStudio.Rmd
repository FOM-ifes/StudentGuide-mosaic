...
\textsf{RStudio} ist eine integrierte Entwicklerumgebung (*integrated development environment* - IDE) für \textsf{R}, die gegenüber anderen eine alternative Schnittstelle zu \textsf{R} mit mehreren Vorteilen bietet:
...
- \textsf{RStudio} läuft auf Mac-, PC-, und Linux-Rechnern und bietet eine vereinfachte Schnittstelle, die vom Aussehen und in der Handhabung auf allen ähnlich ist. Die Standardschnittstellen für \textsf{R} sind ziemlich unterschiedlich auf den verschiedenen Platformen. Das kann verwirren oder ablenken und zu höherem Unterstützungsaufwand führen.
