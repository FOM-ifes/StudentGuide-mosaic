...
`prop.test()` berechnet die Chi-Quadrat-Statistik. Die meisten einführenden Statistikbücher nutzen die Z-Statistik. Mathematisch sind sie inBezug auf inferentielle Aussagen äquivalent.
:::
