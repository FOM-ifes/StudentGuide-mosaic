...
Um \textsf{Markdown} oder \textsf{knitr/LATEX} nutzen zu können, muss das Paket `markdown` installiert sein.
:::

Die Einführung in \textsf{R Markdown} erfolgt typischerweise zu Beginn des Kurses, begleitet von der Aufforderung dies von vornherein für Seminar- und Hausarbeiten etc. zu nutzen [@baumer2014r].
