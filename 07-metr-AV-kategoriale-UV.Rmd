...
:::{.note data-latex="{note}"}
In einem Vortrag präsentierte mal ein Biologen stolz mehrere Boxplots nebeneinander. Das Publikum war beeindruckt von den Ergebnissen und jemand fragte naiv nach, wie viele Beobachtungen in jeder Gruppe enthalten seien. \glqq Vier\grqq{}, antwortete der Biologe.
:::
...
\index{Tukey's Honest Significant Differences (HSD)}
\index{factor()}
\index{labels Option}
\index{levels Option}
